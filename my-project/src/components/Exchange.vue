  ...
  <!--<div id="container" class="margin_center content-center">-->
    ...
    <!--<div class="clear">-->
      <!--<div class="buyleft">-->
        ...
        <!--<div class="left-content">-->
          ...
          <!--<div class="sureBuy">-->
            <!--&lt;!&ndash;<el-tooltip :disabled="false" content="请先进行登录" placement="bottom" effect="dark">&ndash;&gt;-->
            <!--&lt;!&ndash;<el-button @click="buyOrSell" type="primary" :disabled="true">{{buySellWord.butt}}</el-button>&ndash;&gt;-->
            <!--&lt;!&ndash;</el-tooltip>&ndash;&gt;-->
            <!--<el-button @click="buyOrSell" type="primary">-->
              <!--{{buySellWord.butt}}-->
            <!--</el-button>-->
            <!--&lt;!&ndash;<el-button @click="buyOrSell" type="primary" :disabled="login || exchangeDisable">&ndash;&gt;-->
            <!--&lt;!&ndash;{{buySellWord.butt}}&ndash;&gt;-->
    ...
    <!-- -webkit-box-sizing:border-box;">-->
        <!--<table style="width: 100%;border-collapse: collapse;">-->
          ...
          <!--</tr>-->
          <!--</thead>-->
          <!--&lt;!&ndash;<transition-group name="list" tag="tbody" style="text-align: center;" class="my-tbody">&ndash;&gt;-->
...
<!--//            url: window.location.host.indexOf('bjex')>-1?window.location.protocol+"//"+window.location.host+"/Api/Area/getOrdersKline1":'http://192.168.2.96:81/Api/Area/getOrdersKline1',-->
            <!--url: 'http://www.bjex.io/Api/Area/getOrdersKline1?symbol=CCC/ETH&range=900000&since=1529051842000&prevTradeTime=1529052769271',-->
            <!--limit: 1000,-->
            <!--intervalTime: 5000,-->
            <!--debug: false,-->
            <!--showTrade: false,-->
    ...
    <!--methods:{-->
      <!--initWebSocket(){-->
        <!--if(window.location.host.indexOf('bjex')>-1){-->
...
<template>
  <div style="height: calc(100vh - 70px);background: #151511;padding-top: 0.5%;box-sizing: border-box;font-size: 0;">
    <div style="width: 22%;height: 100%;display:inline-block;vertical-align: top;padding-left: 0.5%;padding-right: 0.5%;box-sizing: border-box;background: #151511;">
      <!--左面板-->
      <div style="height: 50%;background: #1C1A13;overflow: auto;color: #ffffff;">
        <!--交易对选择面板-->
        <div class="symbol">
          <div class="dot"></div>
          <div>
  ...
  display: flex;align-items: center;justify-content: space-between;">
            ...
            <table class="table">
              ...
              <tbody>
                <tr style="height: 30px;line-height: 30px;">
                  ...
                  <th class="font-right">最新价</th>
                  <th class="font-left" style="padding-left: 10px;">涨幅</th>
                </tr>
              </tbody>
            </table>
            <div class="newmarket" style="height: 50px;overflow: auto">
              <table class="table">
                <colgroup style="width:23%;"></colgroup>
                <colgroup style="width:45%;"></colgroup>
                <colgroup style="width:25%;"></colgroup>
                ...
                <tr>
                  <td class="">
                    <!--<img src="../assets/img/starLight.png" alt="">-->
                    <img src="../assets/img/starDark.png" alt="">
                    <span>ETH</span>
                  </td>
                  <td class="font-right"><span>0.001240/51.92CNY</span></td>
                  <td class="font-left" style="color: #898989;padding-left: 10px;"><span>-0.13%</span></td>
                </tr>
                <tr>
                  <td class="">
                    <!--<img src="../assets/img/starLight.png" alt="">-->
      ...
      <div style="height: calc(50% - 10px);background: #21201A;margin-top: 10px;color: #FFFFFF;">
        ...
        <div style="width: 100%;height: calc(100% - 38px);" class="realTransact">
          <table class="table">
            <colgroup style="width:23%;"></colgroup>
            ...
            <tbody>
              <tr>
                ...
                <td class="font-right"><span>价格（BTC）</span></td>
                <td class="font-left" style="color: #898989;padding-left: 10px;"><span>数量（COC）</span></td>
              </tr>
            </tbody>
          </table>
            ...
            <table style="width: 100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="font-right"><span>0.001243</span></td>
                  <td class="font-left" style="color: #898989;padding-left: 10px;">
                    <span>1.600</span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="font-right"><span>0.001243</span></td>
                  <td class="font-left" style="color: #898989;padding-left: 10px;"><span>1.600</span></td>
                </tr>
                <tr>
                  <td>
                    <span>10:23:52</span>
    ...
    <!--中间面板-->
    <div style="width:calc(48% - 20px);height: 100%;display:inline-block;margin: 0 10px;">
      <!--k线图面板-->
      <div style="height: 50%;color: #FFFFFF;">
        <div style="height: 60px;">
          <div>
            <span class="font16">{{areaId + '/' + currencyId}}</span>
            <span class="font16">0.001240</span>
            <span class="font14">≈ 51.92 CNY</span>
          </div>
          <div>
      ...
      <div style="height: calc(50% - 10px);background: #21201A;margin-top: 10px;color: #FFFFFF;">
        <div style="height: 38px;line-height: 38px;background: #1C1A13;">
          <div class="deputeTabLeft">
            <span>当前委托</span>
            <span>历史委托</span>
          </div>
          <div class="deputeTabRight">
              <span>买入</span>
              <span>卖出</span>
              <span>全部</span>
          </div>
        ...
        <div class="symbolTable">
          <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td class="font-left"><span>价格（BTC）</span></td>
                <td class="font-left"><span>数量（COC）</span></td>
                <td class="font-left"><span>交易总额（BTC）</span></td>
                <td class="font-left"><span>委托总额（BTC）</span></td>
          ...
          <div class="realTransScroll">
            <table style="width: 100%">
              ...
              <colgroup style="width:10%;"></colgroup>
              <tbody>
                <tr v-for="item in currentDepute">
                  <td><span style="padding-left: 10px;">{{item.time}}</span></td>
                  <td><span>0.001243</span></td>
                  <td>
                    <span>1.600</span>
                  </td>
                  <td><span>0.001243</span></td>
                ...
                <tr v-if="showMyOrAndTraDate.length == 0" >
    ...
    <div style="width: 29%;height: 100%;display:inline-block;vertical-align: top;color: #FFFFFF;">
      <!--最新价格面板-->
      <div style="height: 50%;background: #21201A;">
        <div style="height: 38px;line-height: 38px;background: #1C1A13;">
          最新价格 0.001240 BTC ≈ 51.92 CNY
        </div>
        <div style="width: 100%;height: calc(100% - 38px);" class="realTransact">
      ...
      <!--交易面板-->
      <div style="height: calc(50% - 10px);background: #21201A;margin-top: 10px;">
        <div style="height: 38px;line-height: 38px;background: #1C1A13;">
          限价交易
        </div>
        <div style="height: 43px;line-height: 43px;border-top: 2px solid #151511;border-bottom: 2px solid #151511;">
          <div style="width: 50%;display: inline-block;padding: 0 10px;box-sizing: border-box;">
            <span style="cursor: pointer">登录</span>／<span style="cursor: pointer;">注册</span> 开始交易 <span style="cursor: pointer;float: right;">充值</span>
          </div><!--
          --><div style="width: 50%;display: inline-block;padding: 0 10px;box-sizing: border-box;">
            <span style="cursor: pointer">登录</span>／<span style="cursor: pointer;">注册</span> 开始交易 <span style="cursor: pointer;float: right;">充值</span>
          </div>
        ...
        <div>
          <div style="width: 50%;display: inline-block;padding: 10px 15px;box-sizing: border-box;">
            ...
            <el-input v-model="buyPrice" placeholder="请输入内容" size="mini" class="exchangePlate">
              <!--<template slot="append" style="background: white;">.com</template>-->
              <span slot="suffix" style="display: inline-block;height: 28px;line-height: 28px;padding-right: 10px;">aaa</span>
            </el-input>
            <div style="height: 20px;background: #1C1A13;padding-left: 10px;">=51.92 CNY</div>
            <div>
              买入量
            </div>
            <el-input v-model="buyNum" placeholder="请输入内容" size="mini" class="exchangePlate"></el-input>
            <div class="block">
              <el-slider
            ...
            <el-button type="primary" size="mini" style="width: 100%;background: #00CC66;border-color: #00CC66;">买入COC</el-button>
          </div><!--
          --><div style="width: 50%;display: inline-block;padding:10px 15px;box-sizing: border-box;vertical-align: top;">
              <div>
                卖出价
              </div>
              <el-input v-model="buyPrice" placeholder="请输入内容" size="mini" class="exchangePlate"></el-input>
          <div style="height: 20px;background: #1C1A13;padding-left: 10px;">=51.92 CNY</div>
              <div>
                卖出量
              </div>
              ...
              <el-button type="primary" size="mini" style="width: 100%;background: #FF5C5C;border-color: #FF5C5C;">买入COC</el-button>
          </div>
        </div>
      </div>
    </div>
...
<style>
  ...
  .newmarket::-webkit-scrollbar,.realTransScroll::-webkit-scrollbar,.newstScroll::-webkit-scrollbar {/*滚动条整体样式*/
    width: 5px;     /*高宽分别对应横竖滚动条的尺寸*/
  }
  .newmarket::-webkit-scrollbar-thumb,.realTransScroll::-webkit-scrollbar-thumb,.newstScroll::-webkit-scrollbar-thumb {/*滚动条里面小方块*/
    border-radius: 10px;
    -webkit-box-shadow: inset 0 0 5px rgba(0,0,0,0.2);
    background: #C5B39B;
  }
  .newmarket::-webkit-scrollbar-track,.realTransScroll::-webkit-scrollbar-track,.newstScroll::-webkit-scrollbar-track {/*滚动条里面轨道*/
    -webkit-box-shadow: inset 0 0 5px rgba(0,0,0,0.2);
    border-radius: 10px;
    background: #000000;
  }
