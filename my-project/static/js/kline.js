...
ChartSettings.init = function () {
  ...
  var _chart_style = 'CandleStickHLC';
  var _m_indic = 'MA';
...
function requestSuccessHandler(res) {
  ...
  var updateDataRes = KlineIns.chartMgr.updateData("frame0.k0", KlineIns.data.Klin);
